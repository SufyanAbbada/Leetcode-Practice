...
var removeDuplicates = function (nums) {
  ...
  for (let i = 1; i < nums.length; i++) {
    ...
    if (element !== uniqueElement) {
      nums[uniqueElementsCount] = element;
...
// let nums = [1,1,1,1,1]                     // k = 1, [1,_,_,_,_]
// let nums = [1,2,3,4,5]                     // k = 5, [1,2,3,4,5]
// let nums = [-3,-3,-2,-1,-1,0,0,1]          // k = 5, [-3,-2,-1,0,1,_,_,_]
// let nums = [0,0,0,0,0,0,0]                 // k = 1, [0,_,_,_,_,_,_]
// let nums = [-1,0,0,0,1,1,2,2,2,3]          // k = 5, [-1,0,1,2,3,_,_,_,_,_]

// let nums = [1]                             // k = 1, [1]
// let nums = [-100,-100]                     // k = 1, [-100,_]
// let nums = [100,100,100]                   // k = 1, [100,_,_]
// let nums = [-2,-1,0,1,2]                   // k = 5, [-2,-1,0,1,2]
// let nums = [0,1,1,1,1,1,1]                 // k = 2, [0,1,_,_,_,_,_]
